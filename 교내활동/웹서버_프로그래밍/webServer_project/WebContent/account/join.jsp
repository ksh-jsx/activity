...
<div class="signup_container">
    <h2>회원가입</h2>
    <form method="post" autocomplete="off" action="joinAction.jsp" class="signup_form">
        ...
        <div class="signup_div">
            ...
            <div class="signup_right">
                <input type="password" name="userPassword" id="id_password1" placeholder="8자 이상" required>
            </div>
        </div>
        <div class="signup_div">
            <div class="signup_left">
            ...
            <div class="signup_right">
                <input type="password" name="userPassword2" id="id_password2" required>
            </div>
        </div>
        <div class="signup_div">
            <div class="signup_left">
        ...
        <div class="signup_div">
            ...
            <div class="signup_right">
                <input type="radio" name="userGender" id="id_userGender1" value="남자" required style="width:15%;"><span style="position:relative;bottom:7px">남자</span>
                <input type="radio" name="userGender" id="id_userGender2" value="여자" required style="width:15%;"><span style="position:relative;bottom:7px">여자</span>
            </div>
        </div>
        <div class="signup_div">
            <div class="signup_left">
            ...
            <div class="signup_right">
               <input type="email" name="userEmail" id="id_userEmail" required>
            </div>
        </div>
        <br>
        <br>
    ...
    <div id="submitDiv" onclick="check_password()" style="cursor:pointer">가입하기</div>    
</div>    
